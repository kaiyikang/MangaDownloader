# -*- coding: utf-8 -*-
"""
Created on Fri May 18 07:38:10 2018
...
class MangaDownloader:
    ...
    def __init__(self,GientUrl):
        self.GientUrl = GientUrl
    ...
    def MangaDownloader(self,photoList):
    ...
    def getBigUrlList(self):
        htmlext = requests.get(self.GientUrl).text
    #使用BeautifulSoup模块来解析html源码
        bigUrlList = []
        soup = BeautifulSoup(htmlext,'html.parser')
